> [!NOTE]
> **Please note:** This tool was an experiment. We planned to improve the [air-blocks](https://github.com/digitoimistodude/air-blocks) workflow with more native approach while retaining coding blocks via [ACF](https://www.advancedcustomfields.com/) and [PHP](https://www.php.net/), but we decided to move on to native core block variations and original WordPress Gutenberg blocks using [@wordpress/scripts](https://www.npmjs.com/package/@wordpress/scripts).
